/*Agora, para o javascript, vamos começar criando algumas funções auxiliares para 
agilizar o processo de criação dos elementos, já que faremos isso várias vezes: */
